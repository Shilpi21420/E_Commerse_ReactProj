...
export default function Product(props) {
  ...
  // useEffect(() => {
  //   fetch(
  //     `https://crudcrud.com/api/f959ed3ac62a4a38b3f4d805bf232dba/cart${userEmail}`,
  //     { method: "GET" }
  //   ).then((res) => {
  //     if (res.ok) {
  //       res.json().then((data) => {
  ...
  const addproductcart = (event) => {
    ...
    if (indxOfItem === -1) {
      ...
      fetch(
        `https://crudcrud.com/api/f959ed3ac62a4a38b3f4d805bf232dba/cart${userEmail}/${apigetData[indxOfItem]._id}`,
        {
          method: "PUT",
          body: JSON.stringify({
            id: props.id,
